    ...
    routes.updateSingleUser = {
        ...
        validate: {
            ...
            payload: {
                ...
                newPassword: Joi.string().min(6).max(50).with('oldPassword').description('The user\'s existing password.'),
                oldPassword: Joi.string().min(6).max(50).with('newPassword').description('The user\'s new password.'),
