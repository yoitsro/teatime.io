...
describe('Group rounds', function () {
    ...
    it('errors on creating a new round because this group doesn\'t exist', function(done) {
        done();
    });
    ...
    it('errors on getting a round because this group doesn\'t exist', function(done) {
        done();
    });
    ...
    it('errors on getting rounds because this group doesn\'t exist', function(done) {
        done();
    });
    ...
    it('errors on deleting a round because this group doesn\'t exist', function(done) {
        done();
    });
